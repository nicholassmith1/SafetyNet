...
def process_frame(intr, dt, frame_cur, frame_prev, bounding_boxes=None):
    ...
    if time[len(time) - 1] > 70:
        ...
        pickle.dump([time, pos_x, pos_y, pos_z, pos_R], open( "motion.p", "wb" ))
...
def main():
    ...
    #           [0         , 0         , 1]])
    frame_rate = 29 # either  24 / 25 / 30p
    ...
    while success:
        ...
        process_frame(intr, 1.0 / frame_rate, frame_cur, frame_prev, bounding_boxes)
