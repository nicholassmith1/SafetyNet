...
OPENMVG_SFM_BIN = "/home/nism/Documents/csci1430/openMVG_Build/Linux-x86_64-RELEASE"
...
pIntrisics = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_SfMInit_ImageListing"),  "-i", input_dir, "-o", matches_dir, "-k", "2246.742;0;1920;0;2246.742;1080;0;0;1", "-c", "3"] )
pIntrisics.wait()
...
print( "6. Pre-process for openMVS")
pRecons = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_openMVG2openMVS"),  "-i", reconstruction_dir+"/sfm_data.bin", "-o", os.path.join(output_dir,"scene.mvs")] )
pRecons.wait()
